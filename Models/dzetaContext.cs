        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Charactersskills>(entity =>
            {
                ...
                entity.HasOne(d => d.Character)
                    ...
                    .HasConstraintName("charactersskills_ibfk_1");

                entity.HasOne(d => d.Skill)
                    .WithMany()
                    .HasForeignKey(d => d.SkillId)
                    .HasConstraintName("charactersskills_ibfk_2");
            });
            ...
            modelBuilder.Entity<Charisms>(entity =>
            {
                ...
                entity.HasIndex(e => e.AbilityBonusId)
                    .HasName("AbilityBonusId");

                entity.Property(e => e.Id).HasColumnType("int(11)");

                entity.Property(e => e.AbilityBonusId).HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Races>(entity =>
            {
                ...
                //entity.Property(e => e.AbilityId).HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Racesskills>(entity =>
            {
                ...
                entity.HasOne(d => d.Race)
                    ...
                    .HasConstraintName("racesskills_ibfk_1");
